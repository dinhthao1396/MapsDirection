...
//        listTypeView.addGestureRecognizer(tap)
    ...
    func testPost(){
        ...
        let todosEndpoint: String = "http://jsonplaceholder.typicode.com/posts/1"
        //let newTodo = ["title": "Frist Psot", "completed": 0, "userId": 1] as [String : Any]
        Alamofire.request(todosEndpoint, method: .post, parameters: parameters, encoding: JSONEncoding.default)
